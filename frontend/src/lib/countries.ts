// Countries with dial codes for nationality + phone auto-fill
...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Tibet', code: 'TB', dialCode: '+86' },
...
export function getDialCode(nationality: string): string {
  const country = COUNTRIES.find(c => c.name.toLowerCase() === nationality.toLowerCase());
